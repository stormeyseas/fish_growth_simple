...
production_cycle <- read_csv("data/_general_data/production_cycles/production_cycle.csv") |> 
  filter(species == this_species) |> pull(days)
...
furrr::future_map(.x = farm_list, .f = \(this_farm){
  ...
  if(!file.exists(saveName)){
     ...
     write.table(x = temp_data_only, file = saveName, col.names = FALSE, row.names = FALSE)
  }
