...
Food_charactisation_list <- 
  read_csv("data/_general_data/diets/protein_lipid_carb_summaries_diet.csv") |> 
  select(-c(5)) |> 
...
Make some stocking density assumptions based on farm tonnage

```{r}

farm_info <- qread("data/_general_data/farm_locations/locations.qs")
